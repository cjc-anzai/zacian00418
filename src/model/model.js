  ...
  export const weaponInfo = {
    かえんほうしゃ: { type: "ほのお", kind: "special", power: 90, hitRate: 100, sound: sounds.weapon.fire1 },
    ほのおのパンチ: { type: "ほのお", kind: "physical", power: 75, hitRate: 100, sound: sounds.weapon.hit3 },
    ハイドロポンプ: { type: "みず", kind: "special", power: 110, hitRate: 80, sound: sounds.weapon.water1 },
    アクアブレイク: { type: "みず", kind: "physical", power: 85, hitRate: 100, sound: sounds.weapon.hit2 },
    "１０万ボルト": { type: "でんき", kind: "special", power: 90, hitRate: 100, sound: sounds.weapon.electric1 },
    タネばくだん: { type: "くさ", kind: "physical", power: 80, hitRate: 100, sound: sounds.weapon.bomb1 },
    はどうだん: { type: "かくとう", kind: "special", power: 80, hitRate: 100, sound: sounds.weapon.ball1 },
    ばくれつパンチ: { type: "かくとう", kind: "physical", power: 100, hitRate: 50,sound: sounds.weapon.hit3 },
    サイコキネシス: { type: "エスパー", kind: "special", power: 90, hitRate: 100, sound: sounds.weapon.esper1 },
    むしのさざめき: { type: "むし", kind: "special", power: 90, hitRate: 100, sound: sounds.weapon.laser1 },
    シャドーボール: { type: "ゴースト", kind: "special", power: 80, hitRate: 100, sound: sounds.weapon.ball1 },
    ときのほうこう: { type: "ドラゴン", kind: "special", power: 150, hitRate: 90, sound: sounds.weapon.beam1 },
    あくうせつだん: { type: "ドラゴン", kind: "special", power: 100, hitRate: 95, sound: sounds.weapon.slash1 },
    ラスターカノン: { type: "はがね", kind: "special", power: 80, hitRate: 100, sound: sounds.weapon.beam2 },
    アイアンテール: { type: "はがね", kind: "physical", power: 100, hitRate: 75, sound: sounds.weapon.hit1 },
    ヘドロばくだん: { type: "どく", kind: "special", power: 90, hitRate: 100, sound: sounds.weapon.bomb1 },
    じしん: { type: "じめん", kind: "physical", power: 100, hitRate: 100, sound: sounds.weapon.ground1 },
    エアスラッシュ: { type: "ひこう", kind: "special", power: 75, hitRate: 95, sound: sounds.weapon.slash2 },
    つららおとし: { type: "こおり", kind: "physical", power: 85, hitRate: 90, sound: sounds.weapon.ice1 },
    じごくづき: { type: "あく", kind: "physical", power: 80, hitRate: 100, sound: sounds.weapon.hit2 },
    ムーンフォース: { type: "フェアリー", kind: "special", power: 95, hitRate: 100, sound: sounds.weapon.flash1 },
  }
